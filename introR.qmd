...
The breadth and complexity of statistical techniques continues grow, making it difficult to learn details of all methods. 
...
To install RStudio go to [www.posit.co](https::/www.posit.co) and follow the links to download the free desktop version of RStudio.
